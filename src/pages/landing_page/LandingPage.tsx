            ...
            <div
                ...
                <div style={{
                    ...
                    <div style={{display: "flex", justifyContent: "center", marginTop: "100px", gap: "50px"}}>
                        <Button style={{backgroundColor: "black", width: "200px", height: "50px"}} onClick={() => window.location.href = "/login"}>
                            Login
                        </Button>
                        <Button style={{backgroundColor: "#009989", width: "200px", height: "50px", opacity: "50%"}} onClick={() => window.location.href = "/login"}>
                            More Information
                        </Button>
                    </div>
                </div>
