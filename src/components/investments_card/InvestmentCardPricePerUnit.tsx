...
function PricePerUnit(props: {winThisMonth: number, totalWin: number}) {
    return (
        <div>
            ...
            <h3 style={{padding: 0, margin: 1, marginBottom: 18, fontWeight: 'bold'}}><Text>{ props.winThisMonth } $</Text></h3>
            <p  style={{padding: 0, margin: 1}}><Text size="2">total win:</Text></p>
            <h3 style={{padding: 0, margin: 1, marginBottom: 18, fontWeight: 'bold'}}><Text>{ props.totalWin } $</Text></h3>
